...
CREATE TABLE VENUE ( VENUE_ID VARCHAR(10),
...
--Results table is superclass table which is used for recoding the final sports results																																																																																																																																																																																																								EVENT_ID INTEGER, @ -159,10 + 181,13 @@ INSERT INTO PARTICIPATES VALUES (2401, 9001); INSERT INTO PARTICIPATES VALUES (2402, 9001); INSERT INTO PARTICIPATES VALUES (2403, 9001); -- This Venue table stores specific information about each places where
 CREATE TABLE "Result" (					
...
INSERT INTO "Result" VALUES (123,98.99,1,9011);
INSERT INTO "Result" VALUES (456,98.99,1,9001);
...
INSERT INTO Scorebased_results VALUES (123,9011,90.20,45.00);
INSERT INTO Scorebased_results VALUES (456,9011,90.20,45.00);
...
INSERT INTO Timebased_results VALUES (456,9001,90.20,80.00);
INSERT INTO Timebased_results VALUES (456,9011,90.20,70.00);
...
CREATE TABLE Evaluate(
	...
	info_id INTEGER NOT NULL,
	offcials_duty VARCHAR(20),
	PRIMARY KEY (official_id,Info_id)
	FOREIGN KEY (official_id) REFERENCES PERSON(pid) ON DELETE CASCADE,
	FOREIGN KEY (info_id) REFERENCES Information(info_id)ON DELETE CASCADE
);
INSERT INTO Evaluate VALUES (20240007,9001,'judge_performance');
INSERT INTO Evaluate VALUES (20240008,9011,'referee_games');	

--judge_performance is one of officials subclass
CREATE TABLE judge_performance (
	official_id INTEGER PRIMARY KEY,
	judge_id INTEGER NOT NULL,
	judge_retults VARCHAR(20),	
...
INSERT INTO Journeys VALUES (111,321,'2024-10-10','14:00:00' 'accommodation','venue');
INSERT INTO Journeys VALUES (121,321, '2024-10-11','14:00:00', 'venue','accommodation');
...
INSERT INTO Vehicles VALUES (111,321,'van',4);
INSERT INTO Vehicles VALUES (121,321, 'bus',15);
...
);																																																				@ -173,18 + 198,9 @@ CREATE TABLE VENUE (CHECK (BUILD_DATE < '2020-01-01')); INSERT INTO VENUE VALUES (105, '1000000.00', '2010-09-04', 005); INSERT INTO VENUE VALUES (205, '3000000.00', '2015-07-22', 006); INSERT INTO VENUE VALUES (305, '5000000.00', '2010-11-14', 007); --CREATE TABLE LivesIn (
INSERT INTO Scheduled VALUES (741,111,'Jane';
INSERT INTO Scheduled VALUES (742,121, 'Make');
...
INSERT INTO booking VALUES (741,'officials','20240007';
INSERT INTO booking VALUES (742,'athlete', '20240008');			
